...
export default function ConveniosClient({ initialConvenios }: ConveniosClientProps) {
    const [convenios] = useState<Convenio[]>(initialConvenios || []);
                                                ...
                                                <Form onSubmit={handleFormSubmit}>
                                                    ...
                                                    <FormGroup className="mb-4">
                                                        ...
                                                        <Input
                                                            ...
                                                            required
                                                            disabled={enviandoSolicitud}
                                                            placeholder="Describí brevemente los beneficios que te gustaría ofrecer a los socios..."
                                                        />
                                                    </FormGroup>
                                                    ...
                                                    <div className="text-end">
                                                        <Button
                                                            type="submit"
                                                            disabled={enviandoSolicitud}
                                                            className="px-4 py-2 hover-scale shadow-sm border-0"
                                                            style={{ 
                                                                backgroundColor: artiguistaColors.azul, 
